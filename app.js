...
function increaseMultiplier() {
    ...
    // After 15 seconds, slightly faster but still slow
    if (elapsed > 15) {
        speed += (elapsed - 15) * 0.0003;
    }
    ...
    // Update cash out button if user has bet and game is running
...
// ==========================================
// Betting phase (10 second countdown - ONLY ONCE)
// ==========================================
function startBettingPhase() {
    ...
    countdownInterval = setInterval(() => {
        ...
        if (countdownValue > 0) {
            ...
            isCountdownRunning = false;
            // IMMEDIATELY start the round - NO DELAY
            startNewRound();
        }
    }, 1000);
}
...
function startNewRound() {
    ...
    isCrashed = false;
    isGameRunning = true;
    // Don't reset bet here - keep it from betting phase
    chartHistory = [];
    ...
    // Cash out button will be shown when multiplier increases
    cashOutButton.style.display = 'none';
    updateChart(1);
    updatePlayers();
    
    // Start the multiplier animation immediately
    if (animationId) cancelAnimationFrame(animationId);
    increaseMultiplier();
}
...
betButton.addEventListener('click', () => {
    ...
    // Read auto cash out value (optional)
    ...
    // Cash out button will be shown when game starts and multiplier increases
    cashOutButton.style.display = 'none';
...
// ==========================================
// Cash Out button - only works when game is running
// ==========================================
...
function crashGame() {
    ...
    // Start betting phase after 1.5 seconds
    setTimeout(() => {
        startBettingPhase();
    }, 1500);
}
...
// ==========================================
// Initialize - Load history and start
// ==========================================
loadAndDisplayHistory();
startBettingPhase();
