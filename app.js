...
function increaseMultiplier() {
    ...
    if (hasBet && !isCashedOut) {
        ...
        // Auto Cash Out check (only if enabled)
...
function startBettingPhase() {
    ...
    countdownInterval = setInterval(() => {
        ...
        if (countdownValue > 0) {
            ...
            // IMMEDIATELY start the round - no second delay
            startNewRound();
        }
    }, 1000);
}
...
betButton.addEventListener('click', () => {
    ...
    if (!isWaiting || !isBettingPhase) {
        resultMessage.textContent = '⏳ Wait for betting phase';
    ...
    // Show cash out button immediately
    cashOutButton.style.display = 'block';
    cashOutButton.textContent = `💰 Cash Out at 1.00x`;
...
// ==========================================
// Auto cash out input - update on change
// ==========================================
