...
// ==========================================
function getSpeed(m) {
    // Aviator-style logarithmic speed
    if (m < 2) return 1/6;      // 1→2: 6 seconds
    if (m < 3) return 1/4;      // 2→3: 4 seconds
    if (m < 4) return 1/3;      // 3→4: 3 seconds
    if (m < 5) return 1/2;      // 4→5: 2 seconds
