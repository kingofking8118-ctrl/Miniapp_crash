...
let autoCashOutCheckInterval = null;
...
function stopGame() {
    ...
    if (autoCashOutCheckInterval) clearInterval(autoCashOutCheckInterval);
    isGameRunning = false;
    isWaiting = true;
}
...
function performCashOut() {
    ...
    if (autoCashOutCheckInterval) {
        clearInterval(autoCashOutCheckInterval);
        autoCashOutCheckInterval = null;
    }
}
